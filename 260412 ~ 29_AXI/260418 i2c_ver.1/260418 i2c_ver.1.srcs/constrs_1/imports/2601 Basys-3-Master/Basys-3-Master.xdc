...
#set_property -dict { PACKAGE_PIN T18   IOSTANDARD LVCMOS33 } [get_ports cmd_write]
#set_property -dict { PACKAGE_PIN W19   IOSTANDARD LVCMOS33 } [get_ports cmd_read]
set_property -dict { PACKAGE_PIN T17   IOSTANDARD LVCMOS33 } [get_ports btn_start]
#set_property -dict { PACKAGE_PIN U17   IOSTANDARD LVCMOS33 } [get_ports cmd_stop]
