...
/*
    ...
    always_comb begin
        case (i_funct3)
            ...
            3'b010:  drdata = dmem[daddr[31:2]];  // LW
            3'b100: begin  // LBU 
                case (daddr[1:0])
                    2'b00: drdata = {24'd0, dmem[daddr[7:0]]};
                    2'b01: drdata = {24'd0, dmem[daddr[15:8]]};
                    2'b10: drdata = {24'd0, dmem[daddr[23:16]]};
                    2'b11: drdata = {24'd0, dmem[daddr[31:24]]};
                endcase
            end
