...
module sr04_controller (
    ...
    wire w_1us_tick;
    localparam IDLE = 3'd0, START = 3'd1, WAIT = 3'd2;
    localparam DIST = 3'd3, AG_IDLE = 3'd4;
    reg [2:0] c_state, n_state;
    parameter BIT_WIDTH = 60_000;
    reg [$clog2(BIT_WIDTH)-1:0] tick_cnt_reg, tick_cnt_next;
    ...
    always @(*) begin
        ...
        case (c_state)
            ...
            AG_IDLE: begin
                if (w_1us_tick == 1'b1) begin
                    if (tick_cnt_reg == (BIT_WIDTH) - 1) begin
                        n_state = IDLE;
                        tick_cnt_next = 0;
                        done_next = 1'b1;
                    end else begin
